...
# 根据下面目录拼接 地址 访问数据
# 浏览器中访问
https://unpkg.com/browse/chinese-poetry/chinese-poetry/dist/lunyu/lunyu.json
# 访问 JSON 数据
https://unpkg.com/chinese-poetry@1.1.0/chinese-poetry/dist/lunyu/lunyu.json
# 访问最新版本 JSON 数据
https://unpkg.com/chinese-poetry/chinese-poetry/dist/lunyu/lunyu.json
```

#### Githack

https://raw.githack.com/chinese-poetry/chinese-poetry/master/dist/mengxue/dizigui.json

#### Statically

https://cdn.statically.io/gh/chinese-poetry/chinese-poetry/master/dist/mengxue/dizigui.json
